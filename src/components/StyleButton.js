...
export default function StyleButton({ title, onPress, variant = 'primary', className = "", disabled = false }) {
  ...
  const finalClasses = disabled ? `${buttonClasses} opacity-60` : buttonClasses;
